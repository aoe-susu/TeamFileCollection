    ...
    <div style="float:left;">
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="emile" value="${condition.emile[0]}" class="form-control" id="exampleInputEmail2">
            </div>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/findCollectionTaskByPageServlet?currentPage=${pb.currentPage-1}&rows=5" aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                    ...
                    <c:if test="${pb.currentPage==i}">
                        <li class="active"><a href="${pageContext.request.contextPath}/findCollectionTaskByPageServlet?currentPage=${i}&rows=5">${i}</a></li>
                    </c:if>
                    <c:if test="${pb.currentPage!=i}">
                        <li><a href="${pageContext.request.contextPath}/findCollectionTaskByPageServlet?currentPage=${i}&rows=5">${i}</a></li>
                    </c:if>
                </c:forEach>
                <c:if test="${pb.currentPage==i}">
                <li class="disabled">
                ...
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/findCollectionTaskByPageServlet?currentPage=${pb.currentPage+1}&rows=5" aria-label="Next">
